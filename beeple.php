            ...
            <div>
                <form action="" method="post">
                    ...
                    <div>
                        ...
                        <label>Date: <input type="date" name="Date"></label> <!-- Date input not supported in all browsers, consider using a polyphill. Also look up what 'polyfill' means-->
                    ...
                    <div>
                        ...
                        <label><input type="radio" name="QueenSeen" value="Yes">Yes</label><br>
                        <p>Marked?</p>
                    ...
                    <div>
                        ...
                        <label><input type="radio" name="LayingPattern" value="NA" checked>N/A</label>
                    </div>
                    ...
                    <div>
                        ...
                        <label><input type="radio" name="Population" value="NA" checked>N/A</label>
                    ...
                    <div>
                        ...
                        <label><input type="radio" name="HoneyStores" value="NA" checked>N/A</label><br>
                        ...
                        <label><input type="radio" name="PollenStores" value="NA" checked>N/A</label>
                    </div>
